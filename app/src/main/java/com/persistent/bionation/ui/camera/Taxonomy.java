...
public class Taxonomy {
    ...
    public void setFilterByTaxonId(Integer taxonId) {
        if (mFilterByTaxonId != taxonId) {
            Log.d(TAG, "setFilterByTaxonId: changing taxonID filter from " + mFilterByTaxonId + " to " + taxonId);
        }
    ...
    public void setNegativeFilter(boolean negative) {
        if (mNegativeFilter != negative) {
            Log.d(TAG, "setNegativeFilter: changing negative filter from " + mNegativeFilter + " to " + negative);
        }
